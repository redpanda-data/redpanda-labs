...
ifdef::env-site[]
. xref:redpanda-labs:docker-compose:attachment$cdc/postgres-json/docker-compose.yml[Download] the following Docker Compose file on your local file system.
+
...
----
include::redpanda-labs:docker-compose:attachment$cdc/postgres-json/docker-compose.yml[]
----
====
endif::[]
