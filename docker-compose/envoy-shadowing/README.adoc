...
ifdef::env-site[]
This lab demonstrates a disaster recovery setup that combines xref:ROOT:manage/disaster-recovery.adoc[Redpanda Shadowing] with https://www.envoyproxy.io/[Envoy proxy^].
endif::[]
ifndef::env-site[]
...
* Redpanda v25.3+ (included in docker-compose.yml)

NOTE: New Redpanda clusters include a 30-day trial license that enables Shadowing.
...
ifdef::env-site[]
* xref:ROOT:manage/disaster-recovery.adoc[Shadowing for Disaster Recovery]
endif::[]
ifndef::env-site[]
