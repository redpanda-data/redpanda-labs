...
- link:{content-url}/clients/chat-room/docker/java/src/main/java/com/example/Admin.java[`src/main/java/com/example/Admin.java`]: Checks whether the `chat-room` topic exists and creates it if not.
- link:{content-url}/clients/chat-room/docker/java/src/main/java/com/example/ChatProducer.java[`src/main/java/com/example/ChatProducer.java`]: A producer that sends strings entered by the user of the terminal to the `chat-room` topic. Messages are sent as JSON encoded strings.
- link:{content-url}/clients/chat-room/docker/java/src/main/java/com/example/ChatConsumer.java[`src/main/java/com/example/ChatConsumer.java`]: A consumer that reads all messages from the `chat-room`
...
- link:{content-url}/clients/chat-room/docker/java/src/main/java/com/example/Main.java[`src/main/java/com/example/Main.java`]: The client application that creates the topic, producer, and consumer and implements the chat logic.
