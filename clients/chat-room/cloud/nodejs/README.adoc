...
- Complete the link:https://docs.redpanda.com/cloud-data-platform/get-started/cluster-types/create-dedicated-cloud-cluster/[Redpanda Cloud Dedicated quickstart] before continuing. This tutorial expands on the quickstart.
