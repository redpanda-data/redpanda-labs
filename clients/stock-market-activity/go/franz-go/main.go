...
func main() {
	...
	clientKey := flag.String("clientKey", "", "Path to PEM-formatted key file.")
	clientCert := flag.String("clientCert", "", "Path to PEM-formatted cert file.")
	ca := flag.String("ca", "", "Path to PEM-formatted CA file.")
	saslMech := flag.String("saslMechanism", "", "'plain', 'SCRAM-SHA-256', or 'SCRAM-SHA-512'")
