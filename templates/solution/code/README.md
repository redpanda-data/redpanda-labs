...
Code for the __title__ solution. The guided walkthrough lives on the docs site
at `/solutions/__slug__/`; this directory is what `make` drives and what the
...
The pages under `docs/modules/__slug__/` in the repository read this directory
