...
// (step {"action":"runShell", "command": "bash ../../setup-tests/tools/rpk-produce.sh", "args": ["src", "Hello, please contact us at support.example.com."]})
// (step {"action":"runShell", "command": "bash ../../setup-tests/tools/rpk-produce.sh", "args": ["src", "Hello, please contact us at help@example.edu."]})
...
```
// (step {"action":"runShell", "command": "rpk topic consume sink --num 2", "output": "/help@example\\.(com|edu)/"})
+
[json, role="no-copy"]
----
{
