...
----
// (step {"action":"runShell", "command": "bash ../../../setup-tests/tools/rpk-produce.sh", "args": ["src", "Hello, please contact us at help@example.com."], "workingDirectory": "."})
// (step {"action":"runShell", "command": "bash ../../../setup-tests/tools/rpk-produce.sh", "args": ["src", "Hello, please contact us at support.example.com."], "workingDirectory": "."})
// (step {"action":"runShell", "command": "bash ../../../setup-tests/tools/rpk-produce.sh", "args": ["src", "Hello, please contact us at help@example.edu."], "workingDirectory": "."})
