...
Code for the Cdc To Lakehouse solution. The guided walkthrough lives on the docs site
at `/solutions/cdc-to-lakehouse/`; this directory is what `make` drives and what the
...
The pages under `docs/modules/cdc-to-lakehouse/` in the repository read this directory
