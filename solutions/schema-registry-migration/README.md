...
Code for the Schema Registry Migration solution. The guided walkthrough lives on the docs site
at `/solutions/schema-registry-migration/`; this directory is what `make` drives and what the
...
The pages under `docs/modules/schema-registry-migration/` in the repository read this directory
