...
* xref:streaming:get-started:rpk-install.adoc[rpk] CLI installed
...
* xref:streaming:deploy:deployment-option/self-hosted/kubernetes/index.adoc[Redpanda on Kubernetes]
